...
app.get('/.well-known/acme-challenge/nvKgfWxXMOjlNywQgB2LM4oLeCyx4WM_pZefE1NFiUQ', async function(req, res) {
  res.send('nvKgfWxXMOjlNywQgB2LM4oLeCyx4WM_pZefE1NFiUQ.mB4H3ZfmvCNgp7G3EJBoGFlVXRCgoyB3HE0ghlJCR7U');
});
